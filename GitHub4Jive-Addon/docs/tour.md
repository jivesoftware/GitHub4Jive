...
* **Sequence 3 & 4:** Jive tile registration --> setup GitHub webhooks
  ...
  * [Service provides tile registration event handler to establish GitHub issue state change webhook](Service sets up tile registration listener](https://github.com/jivesoftware/GitHub4Jive/blob/master/GitHub4Jive-Addon/tiles/github-issues-recent/backend/controller.js#L54)
